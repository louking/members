...
with app.app_context():
    ...
    memberemail.template = '\n'.join([
        ...
        'https://members.loutilities.com/admin/fsrc/taskchecklist.',
        '</p>',
        '<p>',
        ...
        '</p>',
        '<table>',
        '   <thead><tr><th>Task</th><th>Status</th><th>Expires</th></tr></thead>',
        '   <tbody>',
    ...
    leaderemail.template = '\n'.join([
        ...
        'tasks. For more details please see https://members.loutilities.com/admin/fsrc/tasksummary.',
        '</p>',
        '<ul>',
