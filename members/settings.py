...
class Config(object):
    ...
    # branding
    THISAPP_PRODUCTNAME = '<span class="brand-all"><span class="brand-left">member</span><span class="brand-right">tility</span></span>'
    THISAPP_PRODUCTNAME_TEXT = 'membertility'
